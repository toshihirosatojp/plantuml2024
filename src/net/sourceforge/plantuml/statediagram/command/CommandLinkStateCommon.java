...
abstract class CommandLinkStateCommon extends SingleLineCommand2<StateDiagram> {
	...
	private EntityImp getEntityStart(StateDiagram diagram, final String codeString) {
	...
	private EntityImp getEntityEnd(StateDiagram diagram, final String codeString) {
		if (codeString.startsWith("[*]"))
	...
	private EntityImp getFoo1(StateDiagram diagram, final String codeString) {
...
//			final Quark ident1 = diagram
//					.buildFromName(StringUtils.eventuallyRemoveStartingAndEndingDoubleQuote(codeString1));
//			final Quark code1 = diagram.buildFromFullPath(codeString1);
