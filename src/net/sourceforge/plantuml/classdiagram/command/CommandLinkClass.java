...
//		}
	...
	private Quark removeMemberPartLegacy1972(AbstractClassOrObjectDiagram diagram, Quark ident) {
		if (ident.getData() != null)
			return null;

		final Quark before = ident.removeMemberPart();
		if (before == null)
			return null;

		final Quark code = before;
		if (code.getData() != null == false)
			return null;
